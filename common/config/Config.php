...
class Config
{
    ...
    // Change the const value into your database value
         ...
         // Mail configuration
            const Mail_Transport = 587;                               const Mail_setFromMail = "servicessototech@gmail.com";

            const Mail_setFromName = Config::AppName;         const Mail_Host = "smtp.gmail.com";
